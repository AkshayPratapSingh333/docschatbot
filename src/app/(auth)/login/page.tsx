      ...
      <div className="w-full max-w-md px-6">
        <div className="bg-slate-800/90 backdrop-blur-sm rounded-2xl shadow-2xl border border-slate-700/50 p-8">
          ...
          <p className="mt-2 text-base text-slate-300 text-center">
            ...
            <Link href='/register'>
              <span className="text-blue-400 hover:text-blue-300 underline cursor-pointer pl-1 font-semibold transition-colors">Sign Up</span>
            </Link>
          </p>
          <p className="mt-2 text-base text-slate-300 text-center">
            Are you an Admin?
          ...
          {message && (
            <p className='bg-blue-950/50 border border-blue-700/50 text-blue-300 font-medium rounded-xl p-3 mt-4'>
              {message}
            </p>
          )}
