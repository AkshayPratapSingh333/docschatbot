...
export  default function Login() {
  ...
  //useSearchParams hook from next/navigation to access the query parameters of the current URL in a Next.js application. The useSearchParams hook returns a URLSearchParams object, which provides methods to read and manipulate the query string of the current URL.
