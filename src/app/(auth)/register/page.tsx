...
export default function SignUp() {
    ...
    // useRouter is used to programmatically navigate between routes in Next.js
    ...
    const submitForm  = async () => {
      ...
      .then((res) => {
        ...
        if(response.status==200){
          router.push(`/login?message=${response.message}`) // Redirect to login page after successful registration
      ...
      <div className="w-full max-w-md px-6">
        <div className="bg-slate-800/90 backdrop-blur-sm rounded-2xl shadow-2xl border border-slate-700/50 p-8">
          ...
          <p className="mt-2 text-base text-slate-300 text-center">
            ...
            <Link href="/login"><span className="text-blue-400 hover:text-blue-300 underline cursor-pointer pl-1 font-semibold transition-colors">Sign In</span></Link>
          </p>
          <form action="#" method="POST" className="mt-8">
            <div className="space-y-5">
                ...
                <div className="relative">
                  ...
                  />
                  <span className="text-red-400 font-medium text-sm mt-1 block">{errors?.name}</span>
                </div>
              </div>
              <div>
                <label className="text-sm font-semibold text-slate-200 block mb-2">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  />
                  <span className="text-red-400 font-medium text-sm mt-1 block"></span>
                </div>
              </div>
              <div className="pt-2">
                <button
